...
class subject_getterSetter1 {
  ...
  var observingAccessorsVar1: Int = 0 {
    @objc // expected-error {{observing willSet observer are not allowed to be marked @objc}} {{5-11=}}
    willSet {
    }
    @objc // expected-error {{observing didSet observer are not allowed to be marked @objc}} {{5-11=}}
    didSet {
    }
  }
}
...
class BadClass2 {
  ...
  var prop3: Int {
    @objc(setProperty:) didSet { } // expected-error{{observing didSet observer are not allowed to be marked @objc}} {{5-25=}}
  }
