...
extension TheReplaceables {
  @_dynamicReplacement(for: property1) // expected-error{{replaced getter for 'property1' occurs in multiple places}}
  ...
  @_dynamicReplacement(for: subscript(_:)) // expected-error{{replaced getter for 'subscript(_:)' occurs in multiple places}}
